...
class Pet:
    own: Owner
    arr_own: List[Owner]  # length=10
    arr_own_v2: List[OwnerV2]  # length=10
    arr_own_v3: List[OwnerV3]  # length=10
    arr_own_v4: List[OwnerV4]  # length=10
    vec_own: List[Owner]
    pet_type: PetType
    arr_pet_type: List[PetType]  # length=2
    vec_pet_type: List[PetType]
    arr_u8: List[int]  # length=100
    d: float
    f: float
    i32: int
    i64: int
    ...
    bval: bool
    s: str
    arr_d: List[float]  # length=2
    arr_f: List[float]  # length=2
    arr_i32: List[int]  # length=2
    arr_i64: List[int]  # length=2
    arr_u32: List[int]  # length=2
    arr_u64: List[int]  # length=2
    arr_bval: List[bool]  # length=2
    arr_s: List[str]  # length=2
    vec_d: List[float]
    vec_f: List[float]
    vec_i32: List[int]
    vec_i64: List[int]
    ...
    def set_arr_own(self, val: List[Owner]) -> None: ...  # length=10
    def get_arr_own_v2(self) -> List[OwnerV2]: ...  # length=10
    def set_arr_own_v2(self, val: List[OwnerV2]) -> None: ...  # length=10
    def get_arr_own_v3(self) -> List[OwnerV3]: ...  # length=10
    def set_arr_own_v3(self, val: List[OwnerV3]) -> None: ...  # length=10
    def get_arr_own_v4(self) -> List[OwnerV4]: ...  # length=10
    def set_arr_own_v4(self, val: List[OwnerV4]) -> None: ...  # length=10
    ...
    def set_arr_d(self, val: List[float]) -> None: ...  # length=2
    def get_arr_f(self) -> List[float]: ...
    def set_arr_f(self, val: List[float]) -> None: ...  # length=2
    def get_arr_i32(self) -> List[int]: ...
    def set_arr_i32(self, val: List[int]) -> None: ...  # length=2
    def get_arr_i64(self) -> List[int]: ...
    def set_arr_i64(self, val: List[int]) -> None: ...  # length=2
    def get_arr_u32(self) -> List[int]: ...
    def set_arr_u32(self, val: List[int]) -> None: ...  # length=2
    def get_arr_u64(self) -> List[int]: ...
    def set_arr_u64(self, val: List[int]) -> None: ...  # length=2
    def get_arr_bval(self) -> List[bool]: ...
    def set_arr_bval(self, val: List[bool]) -> None: ...  # length=2
    def get_arr_s(self) -> List[str]: ...
    def set_arr_s(self, val: List[str]) -> None: ...  # length=2
